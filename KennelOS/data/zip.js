...
// compression). Copied verbatim from KennelPapers/data/zip.js (itself from
// Receipts) so the Documents viewer (data/papersSnapshot.js) can read a Kennel
// Papers backup .zip without vendoring a third-party zip library. Only readZip
// is used here; createZip rides along unchanged to keep the file identical to
// its source of truth. PDFs are already compressed, so store-only is fine.
//
